var seccionesPagina = new fullpage('#fullpage', {
    ...
    anchors: ['inicio', 'informacion', 'invitados', 'galeria'], // Anclas, las usamos para identificar cada seccion y poder acceder a ellas con el menu.
    //navigationTooltips: ['Inicio', 'Productos', 'Contact'], // Tooltips que mostrara por cada boton.
    showActiveTooltip: false, // Mostrar tooltip activa.
    // ──────────────────────────────────────────────────
    //   :::::: Secciones
    // ──────────────────────────────────────────────────
    sectionsColor: ['#0F0B30', '#0F0B30', '#0F0B30', '#0F0B30'], // Color de fondo de cada seccion.
